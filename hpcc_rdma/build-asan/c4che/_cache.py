...
CC = ['/usr/bin/gcc']
CCDEFINES = ['_DEBUG']
CCFLAGS = ['-O0', '-ggdb', '-g3', '-g', '-O1', '-fsanitize=address', '-fno-omit-frame-pointer', '-Wno-error=deprecated-declarations', '-fstrict-aliasing', '-Wstrict-aliasing']
...
LIB_RT = ['rt']
LIB_ST = '-l%s'
LINKFLAGS = ['-fsanitize=address', '-fsanitize=address']
...
NS3_EXECUTABLE_PATH = ['/root/hpcc_rdma/build-asan/src/emu', '/root/hpcc_rdma/build-asan/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/9', '/root/hpcc_rdma/build-asan']
...
cfg_files = ['/root/hpcc_rdma/build-asan/ns3/config-store-config.h', '/root/hpcc_rdma/build-asan/ns3/core-config.h']
cprogram_PATTERN = '%s'
